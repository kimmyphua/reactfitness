...
function SetUp() {
    ...
    // let newGraphData = graphData?.slice().sort((a,b) =>(new Date(a.date) - new Date(b.date)))
    // .map(g => ({...g, date: g.date.split("T")[0] }))
                        ...
                        <Row>
                            <Col md={5}>
                                ...
                                <Row className="form-floating my-1 py-1 w-75 mx-5 ">
                                    ...
                                    <label className="text-dark text-start mx-2" htmlFor="floatingSelect">Current gender: <text className="text-danger fw-bold"> Enter Age</text></label>
                                </Row>
                                ...
                                <Row className="form-floating my-1 py-1 w-75 mx-5">
                                    ...
                                    <label className="text-dark text-start mx-2" htmlFor="floatingSelect">Activity Level</label>
                                ...
                                <Row className="form-floating my-1 py-1 w-75 mx-5">
                                    ...
                                    <label className="text-dark text-start mx-2" htmlFor="floatingSelect">Choose Goal</label>
                                </Row>
                            ...
                            {/*<Col md={7}>*/}
                            {/*    <MTable user={user} newGraphData={newGraphData} setGraphData={setGraphData} />*/}
                            {/*</Col>*/}
                        </Row>
