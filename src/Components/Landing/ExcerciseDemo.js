...
import ExerciseViewDemo from "./ExerciseViewDemo";
...
function ExerciseDemo() {
    ...
    const [keyword, setKeyword] = useState("running")
...
// console.log(exercise)
    ...
    return (
        <div>
            <Button className="bg-white border-dark border-1 text-dark" onClick={()=>setShow(true)}>Try Exercise Demo</Button>
